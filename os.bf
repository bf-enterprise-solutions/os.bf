...
[-]
[Printing thee copyright notice leaves the memory with garbage values in the files section.
Cleaning the memory before proceeding gets rid of some file corruption bugs.
We should be at cell #155 here
]
...
[Now return to the start of the tape while erasing behind us]<
